...
const envSchema = z.object({
  ...
  CAC_VAS_ENABLED: z.enum(["true", "false"]).default("false").transform((value) => value === "true"),
  CAC_VAS_BASE_URL: z.string().url().default("https://vasapp.oasisproducts.ng"),
  CAC_VAS_API_KEY: z.string().default(""),
  CAC_VAS_TIMEOUT_MS: z.coerce.number().int().positive().default(8000),
